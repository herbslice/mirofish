...
class Config:
    ...
    LLM_PROVIDER = os.environ.get('LLM_PROVIDER', '')  # 'openai', 'anthropic', 'codex-cli'
    ...
    def validate(cls):
        ...
        if cls.LLM_PROVIDER != 'codex-cli' and not cls.LLM_API_KEY:
            errors.append("LLM_API_KEY not configured (set LLM_PROVIDER=codex-cli to use CLI instead)")
        return errors
